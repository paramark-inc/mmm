...
def test_plot_all_metrics(output_dir):
    ...
    metric1_costs = metric1_values * 100.
    metric2_costs = metric2_values * 200.
    metric3_costs = metric3_values * 300.
    ...
    input_data = InputData(
        ...
        media_costs=np.array([metric1_costs.sum(), metric2_costs.sum(), metric3_costs.sum()], dtype=np.float64),
