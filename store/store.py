...
from mmm.impl.lightweight_mmm.lightweight_mmm.utils import load_model as lwmmm_load_model
from mmm.impl.lightweight_mmm.lightweight_mmm.utils import save_model as lwmmm_save_model
